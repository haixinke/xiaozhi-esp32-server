#!/usr/bin/env bash
# ============================================================================
# manager-web（前端控制台）镜像构建 + 推送执行器（本地运行）
# ============================================================================
#
# 使用方法：
#   1. chmod +x scripts/run-build-web.sh
#   2. bash scripts/run-build-web.sh
...
exec bash "$SCRIPT_DIR/../docs/aliyun/sae-deployment/scripts/build-push-manager-web.sh"
