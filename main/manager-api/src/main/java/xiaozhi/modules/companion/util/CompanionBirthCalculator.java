...
public final class CompanionBirthCalculator {
    ...
    private CompanionBirthCalculator() {
    }
    ...
    public static BirthResult calculate(LocalDateTime birthTime) {
        ...
        char yearBranch = yearPillar.charAt(1);
        String chineseZodiac = ZHI_SHENGXIAO.getOrDefault(yearBranch, "rat");
    ...
    public record BirthResult(String bazi, String wuxing, String zodiac, String chineseZodiac) {
    }
}
