...
CREATE TABLE ai_companion (
    ...
    quirks_text     VARCHAR(256) NULL     COMMENT '职业病描述',
    soul_traits     VARCHAR(32)  NOT NULL COMMENT '灵魂特质,逗号分隔',
    soul_quirk      VARCHAR(32)  NOT NULL COMMENT '小任性',
    relation_type   VARCHAR(32)  NOT NULL COMMENT '关系类型',
    intimacy        FLOAT        NULL     COMMENT '亲密程度: 0.0~1.0',
    ...
    past_life_secret VARCHAR(256) NULL    COMMENT '前世秘密',
