#!/usr/bin/env bash
# ============================================================================
# manager-api（后端服务）镜像构建 + 推送执行器（本地运行）
# ============================================================================
#
# 使用方法：
#   1. chmod +x scripts/run-build-manager.sh
#   2. bash scripts/run-build-manager.sh
...
exec bash "$SCRIPT_DIR/../docs/aliyun/sae-deployment/scripts/build-push-manager-api.sh"
